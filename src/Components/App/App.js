...
class App extends React.Component {
  constructor(props) {
    ...
    this.removeTrackAfterSuccessSave = this.removeTrackAfterSuccessSave.bind(this);
  ...
  removeTrackAfterSuccessSave(){
    console.log("Removing tracks from playList")
  ...
  async savePlaylist() {
    ...
    this.removeTrackAfterSuccessSave();
